    ...
    <section className="hero-section">
      <div className="hero-text">
        ...
        <p>
          ...
          Before that, I was an AI Resident at <a href="https://ai.meta.com/">FAIR (Meta)</a>,
          where I was a core contributor to{' '}
          <a href="https://arxiv.org/abs/2407.21783">Llama 3</a> — shipping tool-use and
          mathematical reasoning capabilities — and co-led{' '}
        ...
        <p>
          When not training models, you&apos;ll find me running long distances, cooking, reading,
          or out with a camera.
        </p>
